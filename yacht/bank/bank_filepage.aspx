<%@ Page Title="" Language="C#" MasterPageFile="~/bank/Site1.Master" ValidateRequest="false" AutoEventWireup="true" CodeBehind="bank_filepage.aspx.cs" Inherits="yacht.bank.WebForm15" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
            ...
            <li class="nav-item h5">
                <%--<a class="nav-link" id="tab6-tab" href="bank_imgpage.aspx#tab6" role="tab" aria-controls="tab6" aria-selected="false">Imageupload&nbsp&nbsp&nbsp<span class="badge badge-pill badge-warning">6</span></a>--%>
