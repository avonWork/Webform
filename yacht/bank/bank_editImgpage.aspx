<%@ Page Title="" Language="C#" MasterPageFile="~/bank/Site1.Master" AutoEventWireup="true" CodeBehind="bank_editImgpage.aspx.cs" Inherits="yacht.bank.WebForm21" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
            ...
            <li class="nav-item h5">
                <a class="nav-link" id="tab5a" href="bank_editFilepage.aspx?id=<%=Request.QueryString["id"]%>#tab5" role="tab" aria-controls="tab5" aria-selected="false">Fileupload&nbsp&nbsp&nbsp<span class="badge badge-pill badge-warning">5</span></a>
            </li>
            <li class="nav-item h5">
