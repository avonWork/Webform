<%@ Page Title="" Language="C#" MasterPageFile="~/font.Master" AutoEventWireup="true" CodeBehind="fontYachts_specification.aspx.cs" Inherits="yacht.WebForm9" %>
    ...
    <div class="left">
        <div class="left1">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <li><a href='fontYachts_specification.aspx?id=<%# Eval("id") %>'><%# Eval("title") %></a></li>
                </ItemTemplate>
                <FooterTemplate>
                    </ul>
                </FooterTemplate>
